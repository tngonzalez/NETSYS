...
@Component({
  selector: 'app-rtr-general',
  templateUrl: './rtr-general.component.html',
  styleUrls: ['./rtr-general.component.css'],
})
export class RtrGeneralComponent {
  isVisible = false; 
  selectedStatus: any;
  datos: any;
