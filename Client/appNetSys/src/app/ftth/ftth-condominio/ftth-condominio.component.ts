...
@Component({
  selector: 'app-ftth-condominio',
  templateUrl: './ftth-condominio.component.html',
  styleUrl: './ftth-condominio.component.css'
})
export class FtthCondominioComponent {
  ftthId: number | null = null;
  datos: any;
  datosC: any; 
  destroy$: Subject<boolean> = new Subject<boolean>();
  displayedColumns = ['numCasa', 'zona'];
  ...
  exportToPDF(): void {
    ...
    if (contentToExport && tableScroll) {
      ...
      html2canvas(container, {
        ...
        pdf.save('Historial_Condominio.pdf');
      });
    } else {
